...
const Product = () => {
  ...
  return (
    <main className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="section-container pt-24 sm:pt-28 pb-4 sm:pb-6">
        <Link
          to="/shop"
          className="group inline-flex items-center gap-2 sm:gap-3 text-gray-400 hover:text-white transition-colors font-black text-xs tracking-wider uppercase"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16">
          ...
          <div ref={imageRef} className="lg:col-span-7 relative">
            <div className="sticky top-20 sm:top-24">
              {/* Main Image */}
              <div className="relative aspect-[3/4] overflow-hidden bg-zinc-900 mb-4 sm:mb-6">
                ...
                <button
                  onClick={prevImage}
                  className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-black/50 backdrop-blur-md border border-white/20 flex items-center justify-center hover:bg-black/70 transition-all hover:scale-110 active:scale-95"
                >
                  <ChevronLeft className="w-4 h-4 sm:w-5 sm:h-5" />
                </button>
                <button
                  onClick={nextImage}
                  className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-black/50 backdrop-blur-md border border-white/20 flex items-center justify-center hover:bg-black/70 transition-all hover:scale-110 active:scale-95"
                >
                ...
                {product.tag && (
                  <motion.span
                    ...
                    className="absolute top-4 sm:top-6 left-4 sm:left-6 bg-red-500 text-white px-3 sm:px-4 py-1.5 sm:py-2 font-black text-xs uppercase tracking-wider z-10"
                  >
                    {product.tag}
                  </motion.span>
                )}
                ...
                {/* Action Buttons */}
                <div className="absolute top-4 sm:top-6 right-4 sm:right-6 flex flex-col gap-2 sm:gap-3 z-10">
                  <button
                    onClick={() => setIsLiked(!isLiked)}
                    className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-black/50 backdrop-blur-md border border-white/20 flex items-center justify-center hover:bg-red-500 hover:border-red-500 transition-all group"
                  >
                    <Heart
                  ...
                  <button className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-black/50 backdrop-blur-md border border-white/20 flex items-center justify-center hover:bg-white hover:text-black transition-all hover:scale-110 active:scale-95">
                    <Share2 className="w-4 h-4 sm:w-5 sm:h-5" />
                  </button>
                </div>

                {/* Image Counter */}
                <div className="absolute bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 px-3 sm:px-4 py-1.5 sm:py-2 bg-black/50 backdrop-blur-md border border-white/20">
          ...
          <div ref={detailsRef} className="lg:col-span-5" style={{ perspective: "1000px" }}>
            ...
            {/* Product Name */}
            <h1 className="detail-item text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-4 sm:mb-6 leading-none tracking-tight">
              {product.name}
            </h1>
            ...
            <div className="detail-item mb-8">
              <div className="flex items-baseline gap-2 sm:gap-3">
                <span className="text-2xl sm:text-3xl md:text-4xl font-black text-red-500">₹{product.price}</span>
                <span className="text-sm sm:text-base text-gray-500 line-through">₹{Math.floor(product.price * 1.3)}</span>
                <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-red-500/20 text-red-500 text-[10px] sm:text-xs font-bold uppercase">
                  23% OFF
                </span>
              </div>
            </div>
            ...
            {/* Description */}
            <p className="detail-item text-base sm:text-lg text-gray-400 mb-6 sm:mb-8 md:mb-10 leading-relaxed max-w-lg">
              {product.description}
            </p>
